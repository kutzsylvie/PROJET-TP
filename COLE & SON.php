...
<div class="row no-gutters">
    <div class="card col-auto mx-auto mt-5" style="width:50rem;">
        <img src="assets/img/MARQUES/colebotanica.jpg" width="10px" class="cardbrand-img-top p-1" alt="image FARROW">
        <div class="card-body text-center">
<!--            <h1 class="card-title">Cole & Son</h1>-->
            <h2 class="card-text">Papiers peints</h2>
            <p> La collection Contemporary Restyled de Cole & Son insuffle une nouvelle vie aux designs des papiers peints les plus populaires de la marque qui ont contribué à son histoire.
            ...
            <div>
                <img src="assets/img/MARQUES//collefort.jpg" width="10px" class="cardbrand-img-top p-1" alt="image FARROW">
            </div>
            <p>Venez découvrir : Hick’s Hexagone, Palm jungle, Rajapur, Woods & Pears, Summer Lily...</p>
            <div>
            <img src="assets/img/MARQUES/collelivre.jpg" width="10px" class="cardbrand-img-top p-1" alt="image FARROW">
            </div>
            <div>
