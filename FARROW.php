...
<div class="row no-gutters">
    <div class="card col-auto mx-auto mt-5" style="width:50rem;">
        <img  src="assets/img/MARQUES/green-smoke-top-image.jpg" width="100px" class="cardbrand-img-top p-1" alt="image FARROW">
        <div class="card-body text-center">
            ...
            <img src="assets/img/MARQUES/5-hegemone-bp5705.jpg" width="10px" class="cardbrand-img-top p-1" alt="image FARROW">
            ...
            <img src="assets/img/MARQUES/farrowroom.jpg" width="10px" class="cardbrand-img-top p-1" alt="image FARROW">
