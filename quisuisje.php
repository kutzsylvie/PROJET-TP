      ...
      <div class="col-md-12">
        <div class="row p-5">
          <div class="col-lg-8 d-flex flex-column justify-content-between">
            ...
            <div>
              <p class="font-weight-bold lead mb-2"><strong>Sandie POTTIER</strong></p>
              <p class="font-weight-bold text-muted">Gérante</p>
            </div>
          </div>
          <div class="col-lg-4 d-flex mb-2 align-items-center">
              <div class="avatar mx-4 w-100 white d-flex justify-content-center align-items-center">
                <img src="assets/img/photosandie.jpg" class="rounded-circle img-fluid z-depth-1" alt="woman avatar">
              </div>
            </div>
        </div>
      </div>
