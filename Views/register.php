...
<div id="contact" class="contact-box">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="form-group col-md-10 card col-md-offset-1">
                ...
                <form class="card-body" method="POST" action="" novalidate="">
                    ...
                    <div class="form-group">
                        ...
                        <input autocomplete="false" name="email" type="mail"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control placeholder" id="message" name="message"
                            placeholder="Votre Message" rows="8" data-error="Ecrivez votre message" required></textarea>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="captcha" id="captcha" class="form-control col font-weight-bold"
                            required /> -->
                    </div>
            </div>
            <input type="submit" class="btn btn-dark font-weight-bold mb-5 mx-auto d-block" value="Valider" />
