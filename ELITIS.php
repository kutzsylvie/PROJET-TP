...
<div class="row no-gutters">
    <div class="card col-auto mx-auto mt-5" style="width:50rem;">
        <img src="assets/img/MARQUES/elitis1.jpg" width="10px" class="cardbrand-img-top p-1" alt="image FARROW">
...
Oser, innover, jouer les explorateurs dans le domaine du textile d’ameublement, du revêtement mural, plutôt traditionnel jusqu’alors, telle est notre philosophie. Concevoir des produits très actuels et avoir toujours une technique d’avance, ce pourrait être notre devise. Notre studio de création intégré, véritable ruche au caractère de laboratoire initiatique, va dans le sens de la recherche, de la diversité et des confrontations. Les propositions, toujours étonnantes, créent l’évènement à chaque salon international.
             ...
             <img src="assets/img/MARQUES/elitis2.jpg" width="10px" class="cardbrand-img-top p-1" alt="image FARROW">
...
En 2010, F&B prend une grande décision en abandonnant les formules à l’huile, pour une refonte totale des gammes à base d’eau, ayant une faible teneur en COV. Par ailleurs, les pots de peintures deviennent recyclables et le papier utilisé pour les papiers peints provient de forêts gérées de manière responsable.</p>
        <img src="assets/img/MARQUES/elitis tissus.jpg" width="10px" class="cardbrand-img-top p-1" alt="image FARROW">
